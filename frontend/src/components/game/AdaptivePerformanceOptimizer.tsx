  ...
  useFrame(() => {
    ...
    if (now - lastTime.current >= 1000) {
      ...
      if (fps < 45) {
        ...
        // After 4 seconds of sustained struggling FPS, scale down graphics properties
        if (struggleSeconds.current >= 4 && !adaptivePotatoMode) {
        ...
        // If performance has stabilized and is highly consistent for 4 seconds, restore higher-fidelity settings
        if (healthySeconds.current >= 4 && adaptivePotatoMode && !settingsRef.current.potatoMode) {
