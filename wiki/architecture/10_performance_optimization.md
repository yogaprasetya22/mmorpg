...
```typescript
if (state.clock.elapsedTime - lastSortTime.current >= 0.1) {
...
🏆 **Wiki Index**: [README.md](README.md) · [09. Animation System](09_animation_system.md) · 📖 [docs/Home.md](../../docs/Home.md)
